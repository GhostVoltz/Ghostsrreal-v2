...
try:
 ...
 print "voce precisa instalar: requests"
 sys.exit()
try:
 import socks
except:
...
'Mozilla/4.0 (compatible; MSIE 7.0; AOL 9.7; AOLBuild 4343.19; Windows NT 5.1; Trident/4.0; .NET CLR 2.0.50727; .NET CLR 3.0.04506.30; .NET CLR 3.0.04506.648; .NET CLR 3.0.4506.2152; .NET CLR 3.5.30729; .NET4.0C; .NET4.0E)', #Anonym0ThugLife
...
'Mozilla/4.0 (compatible; MSIE 6.0; AOL 8.0; Windows NT 5.1; SV1; .NET CLR 1.1.4322)', #AnonymousThugLife
...
'Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.1pre) Gecko/20061202 BonEcho/2.0.0.1pre', #Anonym0ThugLife
...
+------------------------------------- H4CK TH3 PL4N3T -------------------------------------+ 
                         ...
                         :: :  :   :: :  :    : :  :   :: : :
                                   ...
                                   10100 10101 10101 0101
                                  01010 01101 10101 1001 01
                                 10011  11101 10101 1011 001
                                0 10101100 01 01010 1010 0101
                              001010110101 00 01010 1010 01010
                             10101010101 01 0 10101 0101 010101
                            01010101  010110 010101 0101 101101
                           11010101        010   00    0   1010
                           10110101      1010101010101010101001
                            011010101     010101010101010101011
                             1010101011     010101010101010101
                               010101010         010101010101
                                1010101010101010101010101011
                                  1010101010101010101010101
                                   01010101010101010101010
                                   10101101010101010101010
                                   10100101001010010101010
...
\033[1;36m##               \033[0;m \033[1;42m==> H4CK TH3 PL4N37 <==\033[0;m          \033[1;36m##\033[0;m 
\033[1;36m___________________________________________________________________\033[0;m
[!] =====> \033[1;42mSeja esperto\033[0;m (Digite o alvo no terminal :) )
    """ 
n=0
while n<1:
 try:
  url=raw_input('\n\n\n\033[1;36mAlvo: (www.exemplo.com ou IP)\n>')
  socket.gethostbyname(url)
  if url!="":
   n+=1
  else:
   print"Nao deixe o site ou IP em branco"
 except:
  print"Digite o dominio ou IP corretamente"
while n<2:
 try:
  port=input("\n\nPorta: (80 ou 443)\n>")
  if port in [80,443]:
...
while n<4:
 try:
  op=input('\nVoce quer fazer um crawl do Alvo\n 1-Sim\n 2-nao\n>')
  if op in [1,2]:
   n+=1
  else:
   print"\nEscolha: 1 ou 2"
 except:
  print"\nEscolha um numero (1 ou 2)"
if op==1:
 ur=raw_input('\nSeu link:\n>')
 h=[]
 pt=[]
